...
class Button:
    def __init__(self, rozliseni_okna, x, y, sirka, vyska, text = '', barva = (255, 255, 255), barva_textu = (0, 0, 0), font = None):
        self.x = x
        self.y = y
        ...
        if font == None:
            self.font = pg.font.SysFont('Arial', int(rozliseni_okna[0] / 36))
