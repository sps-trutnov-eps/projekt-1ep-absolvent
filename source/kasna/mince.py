...
class Mince:
    def __init__(self, x, y, typ=None):
        ...
        if self.type == "1":
            self.radius = 8
            self.hodnota = 1
            self.textura=pygame.image.load("source//kasna//1.png").convert_alpha()
        elif self.type == "2":
            self.radius = 10
            self.hodnota = 2
            self.textura=pygame.image.load("source//kasna//2.png").convert_alpha()
        elif self.type == "5":
            self.radius = 12
            self.hodnota = 5
            self.textura=pygame.image.load("source//kasna//5.png").convert_alpha()
        elif self.type == "10":
            self.radius = 17
            self.hodnota = 10
            self.textura=pygame.image.load("source//kasna//10.png").convert_alpha()
        elif self.type == "20":
            self.radius = 20
            self.hodnota = 20
            self.textura=pygame.image.load("source//kasna//20.png").convert_alpha()
        elif self.type == "50":
            self.radius = 25
            self.hodnota = 50
            self.textura=pygame.image.load("source//kasna//50.png").convert_alpha()
        elif self.type == "sputnik":
            self.radius = 50
            self.hodnota = 10000
            self.textura=pygame.image.load("source//kasna//sputnik.png").convert_alpha()
